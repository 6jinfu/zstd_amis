...
1. **创建**：项目名、类别、分析目标、引用当前生效的组织结构版本。
...
- 人才测评列表支持按项目名称、匹配产品、项目截止日期、项目进度、创建人、项目来源和项目状态筛选；字段为项目名称、匹配产品、项目截止日期、项目进度、创建人、状态、项目来源、操作。
- 考试列表支持按考试名称 / 编号、关联岗位和考试类型筛选；字段为考试编号、考试名称、关联岗位、考试类型、状态、操作。
